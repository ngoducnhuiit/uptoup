<?php
namespace Magepow\UploadPdf\Ui\DataProvider\Product\Form\Modifier;
...
class BundlePdf extends AbstractModifier
{
    ...
    public function __construct(
        ...
        \Magepow\UploadPdf\Helper\Data $helper,
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'elementTmpl' => 'Magepow_UploadPdf/components/file-uploader',
                                    "previewTmpl" => 'Magepow_UploadPdf/components/preview',
                                    'fileInputName' => self::FIELD_CODE,
                                    'uploaderConfig' => [
                                        'url' => $this->urlBuilder->getUrl(
                                            'uploadpdfadmin/product_file/upload',
